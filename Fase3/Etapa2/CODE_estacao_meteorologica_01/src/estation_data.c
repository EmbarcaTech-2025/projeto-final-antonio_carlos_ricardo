...
int16_t estation_data_json(EstationData * estation_data, char * buf){
    ...
    if(config_data.sensor_analog_ar_co <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
    ...
    if(config_data.sensor_analog_ar_co2 <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
    ...
    if(config_data.sensor_analog_ar_o3 <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
    ...
    if(config_data.sensor_analog_soil_temperature <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
    ...
    if(config_data.sensor_analog_soil_humidity <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
    ...
    if(config_data.sensor_analog_uv_index <= AD_MAX_PORT){
        if(have_sensor) size += sprintf(&(buf[size]), ",");
        have_sensor = true;
