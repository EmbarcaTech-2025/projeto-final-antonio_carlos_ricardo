...
void config_data_set_default(){
    ...
    strcpy(config_data.station_latitude,  "0.000000");
    strcpy(config_data.station_longitude, "0.000000");
    strcpy(config_data.station_elevation, "0.0");
    strcpy(config_data.wifi_ssid,         "MEU_WIFISSID");
    strcpy(config_data.wifi_psw,          "WIFI_PSW");
    strcpy(config_data.server_ip,         "Ip_do_servidor");

    config_data.server_port                    = 8080;

    config_data.period_acquisition             = PERIOD_ACQUISITION_MIN;
    config_data.period_retry                   = PERIOD_10SEC;
...
char * config_data_period_string(Period period){
    switch(period){
        ...
        case PERIOD_2HOUR:  return "2 horas";
        case PERIOD_6HOUR:  return "6 horas";
        case PERIOD_12HOUR: return "12 horas"; 
