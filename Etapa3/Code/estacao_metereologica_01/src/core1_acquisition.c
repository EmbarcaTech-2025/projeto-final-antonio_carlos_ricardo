...
void core1_acquisition_get(){
    ...
    // get time
    core1_estation_data.t_aquire = rtc_ds3231_get();
...
static void __not_in_flash_func(core1_acquisition_write_data_on_flash)(uint32_t index) {
    ...
    flash_range_program(STORAGE_OFFSET_DATA_FIRST + (index * STORAGE_ADDRESS_DATA_SIZE), (uint8_t *)&core1_estation_data, sizeof(core1_estation_data));
...
void core1_acquisition_save(){
    ...
    core1_acquisition_write_data_on_flash(index);
